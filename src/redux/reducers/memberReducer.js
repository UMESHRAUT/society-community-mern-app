const { MEMBER_LOGIN_REQUEST, MEMBER_LOGIN_SUCESS, MEMBER_LOGIN_FAIL, MEMBER_REGISTER_REQUEST, MEMBER_REGISTER_SUCESS, MEMBER_REGISTER_FAIL, MEMBER_LIST_REQUEST, MEMBER_LIST_SUCESS, MEMBER_LIST_FAIL, MEMBER_DETAILS_REQUEST, MEMBER_DETAILS_SUCESS, MEMBER_DETAILS_FAIL } = require("../constants/memberConstants");
...
function memberDetailsReducer(state={},action){
    switch (action.type) {
        case MEMBER_DETAILS_REQUEST:
            return {loading:true}
        case MEMBER_DETAILS_SUCESS:
            console.log(action.payload)
            return {loading:false,responce:action.payload};
...
export {
    memberLoginReducer,memberRegisterReducer,memberListReducer,memberDetailsReducer
}