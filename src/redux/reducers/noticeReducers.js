const { ADD_NOTICE_SUCESS, ADD_NOTICE_REQUEST, ADD_NOTICE_FAIL, GET_NOTICE_REQUEST, GET_NOTICE_SUCESS, GET_NOTICE_FAIL,EDIT_NOTICE_REQUEST,EDIT_NOTICE_SUCESS, EDIT_NOTICE_FAIL } = require("../constants/noticeConstants");
...
export{
    addNoticeReducer,getNoticeReducer,EditNoticeReducer
}