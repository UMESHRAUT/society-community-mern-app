...
function Society(props) {
    ...
    const deleteSociety=()=>{
        ...
        fetch(`/api/admin/society/${props.match.params.id}`,{method:"delete"}).then(rep=>rep.json()).then(msg=>alert(msg.msg))
    ...
    const changeRole=async(member)=>{
        ...
        await fetch(`/api/admin/member-role/${member._id}`,
        {method:'put',
    ...
    return (
        ...
        <div className="society-details">
            <div className="box-heading">
                ...
                <div className="deleteSociety" onClick={()=>confirm_cancle()}><RiDeleteBinLine  className="deleteBtn"/></div>
            </div>
